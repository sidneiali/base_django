...
from .navigation import get_request_sidebar_modules, get_request_topbar_shortcuts
from .preferences import get_user_interface_preference_values


def sidebar_modules(request):
    """
    Injeta a navegação do sidebar em todos os templates autenticados.
    ...
    """
    return {
        "sidebar_modules": get_request_sidebar_modules(request),
