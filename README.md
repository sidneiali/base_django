...
- a avaliação arquitetural para um futuro modo multiempresa centralizado ficou registrada em [`docs/company_multitenancy_study.md`](c:\Users\sidne\OneDrive\Desktop\base_django\docs\company_multitenancy_study.md), agora revisada para o modelo em que usuários comuns pertencem a uma unica empresa e apenas `superadmin` permanece global
